/*
  # Fix log_invoice_update function to use department_id instead of department

  ## Problem
  - The log_invoice_update function references OLD.department and NEW.department
  - These columns don't exist in the invoices table
  - The correct column name is department_id

  ## Changes
  - Update log_invoice_update function to use department_id instead of department
  - Remove the department tracking since we now use invoice_departments table
*/
