/*
  # Ulepsz szczegóły logowania transferów faktur

  1. Zmiany
    - Dodaj imiona i nazwiska do logów transferu faktur
    - Pokaż kto dokonał transferu
    - Pokaż do kogo została przypisana faktura
    - Bardziej szczegółowy opis dla historii zmian

  2. Usprawnienia
    - Lepszy wgląd w historię transferów
    - Łatwiejsze śledzenie kto i do kogo przekazał fakturę
*/
