/*
  # Usuń debug logowanie z handle_invoice_approval

  Przywrócenie czystej wersji triggera bez debug INSERT'ów.
  Logika sprawdzania limitów dla Kierownika/Dyrektora przeniesiona do frontendu.
*/
